...
public class AlignWithCube extends Command {
	private double alignment;
	  ...
	  public AlignWithCube() {
		    ...
		    this.alignmentController = new PIDController(DriveTrain.driveP,
		        DriveTrain.getDriveTrain().driveI, 0); // PID CONSTANTS NEED TUNING
		    // this.alignmentController.setDoneRange(10);
