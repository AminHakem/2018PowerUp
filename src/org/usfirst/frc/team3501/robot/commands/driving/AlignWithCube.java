...
public class AlignWithCube extends Command {
  ...
  public AlignWithCube() {
    ...
    alignmentControllerX = new PIDController(DriveTrain.driveSidewaysP,
        DriveTrain.driveSidewaysI, 0);
    alignmentControllerX.setDoneRange(3);

    alignmentControllerY = new PIDController(DriveTrain.driveStraightP,
        DriveTrain.driveStraightI, 0);
  ...
  protected boolean isFinished() {
    return this.alignmentControllerX.isDone()
        && this.alignmentControllerY.isDone();
  }
