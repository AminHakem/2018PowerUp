...
public class AlignWithCube extends Command {
	...
	public AlignWithCube() {
		...
		alignmentController = new PIDController(DriveTrain.driveSidewaysP, DriveTrain.driveSidewaysI, 0);
	...
	protected void initialize() {
		...
		thread.run(); // this thread will continuously update the threadOutput
						// variable in DriveTrain
	}
