...
public class DriveTrain extends Subsystem {
	...
	public static final double INCHES_PER_PULSE = WHEEL_DIAMETER * Math.PI / ENCODER_PULSES_PER_REVOLUTION;
	...
	/**
	 * Mecanum Drive - takes in the ySpeed, xSpeed, Z Rotation, and Gyro Angle
	 * as parameters and enters those arguments in the driveCartesian method
	 *
	 * @param sidewaysSpeed
	 * @param frontbackSpeed
	 * @param rotation
	 * @param is
	 *            fieldOriented or not
	 */
	public void mecanumDrive(final double sidewaysSpeed, final double frontbackSpeed, final double rotation) {
	...
	public double getRightLeftEncoderDistance() {
		return -ENCODER_DIST_CALIBRATION * leftRightEncoder.getQuadraturePosition() * INCHES_PER_PULSE / 4.0;
	}

	public double getFrontBackEncoderDistance() {
		return ENCODER_DIST_CALIBRATION * frontBackEncoder.getQuadraturePosition() * INCHES_PER_PULSE / 4.0;
	}
