...
public class StartLeftSwitchLeft extends CommandGroup {
  ...
  public StartLeftSwitchLeft() {
    addSequential(new DriveForward(
        LEFT_TO_CENTER_OF_SWITCH_VERTICAL_DISTANCE * Constants.Auton.SCALE_FACTOR_TESTING, 15.5));
    ...
    addSequential(new DriveForward(
        HORIZONTAL_DISTANCE_LEFT_SIDE_TO_CENTER_OF_SWITCH * Constants.Auton.SCALE_FACTOR_TESTING,
        6.5));
