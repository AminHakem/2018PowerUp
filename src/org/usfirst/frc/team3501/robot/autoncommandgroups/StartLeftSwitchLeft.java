...
public class StartLeftSwitchLeft extends CommandGroup {
  ...
  public static final double HORIZ_SWITCH_DIST = 52.0;

  public StartLeftSwitchLeft() {
    addSequential(new MoveToTarget(Elevator.SWITCH_POS, 5));
    addSequential(new DriveForward((VERT_SWITCH_DIST - ROBOT_LENGTH / 2) * SCALE, 15.5));
    addSequential(new TurnForAngle(90.0, 5.0));
    addSequential(new DriveForward((HORIZ_SWITCH_DIST - ROBOT_LENGTH / 2) * SCALE, 6.5));
