...
public class CenterToLeft extends CommandGroup {
  ...
  public CenterToLeft() {
    ...
    addSequential(new DriveForward(
        MIDDLE_TO_CUBES_BEFORE_SWITCH * Constants.Auton.SCALE_FACTOR_TESTING,
        10));
    // turn 90 degrees left
    addSequential(new TurnForAngle(90.0, Constants.Direction.LEFT, 3.0));
    // move forward 60 inches
    addSequential(
        new DriveForward(MIDDLE_TO_CENTER_OF_SWITCH_HORIZONTAL_DISTANCE
            * Constants.Auton.SCALE_FACTOR_TESTING, 6.5));
    // turn 90 degrees right
    addSequential(new TurnForAngle(90.0, Constants.Direction.RIGHT, 3.0));
    // move forward 42 inches
    addSequential(new DriveForward(VERTICAL_DISTANCE_TO_CENTER_OF_SWITCH
