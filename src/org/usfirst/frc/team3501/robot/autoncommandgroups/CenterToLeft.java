...
public class CenterToLeft extends CommandGroup {
  ...
  public CenterToLeft() {
    ...
    // move forward 90 in
    addSequential(
        new DriveForward(MIDDLE_TO_CUBES_BEFORE_SWITCH
            * Constants.Auton.SCALE_FACTOR_TESTING, 10));
    // turn 90 degrees left
    addSequential(new TurnForAngle(-90.0, 3.0));
    // move forward 60 inches
    addSequential(new DriveForward(
        MIDDLE_TO_CENTER_OF_SWITCH_HORIZONTAL_DISTANCE
    ...
    addSequential(new DriveForward(
        VERTICAL_DISTANCE_TO_CENTER_OF_SWITCH
            * Constants.Auton.SCALE_FACTOR_TESTING,
        5));
