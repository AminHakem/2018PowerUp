...
public class CenterToRight extends CommandGroup {
  ...
  public CenterToRight() {
    ...
    // drive 84 in.
    addSequential(
        new DriveForward(CUBE_TO_RIGHT_WALL_HORIZONTAL
            * Constants.Auton.SCALE_FACTOR_TESTING, 9));
    ...
    addSequential(new DriveForward(
        RIGHT_WALL_TO_MIDWAY_RIGHT_BETWEEN_SWITCHWALL
    ...
    // drive 12 in.
    addSequential(new DriveForward(
        MIDWAY_RIGHT_SCALEWALL_TO_RIGHT_SWITCH
            * Constants.Auton.SCALE_FACTOR_TESTING,
        5));
    ...
    System.out.println(
        "TimeTaken for " + this.getClass().getName() + " : " + timer.get());
  }
}
